...
// WP JQPlot Widget
// - - - - - - - - - - - - - - - - - - - - - - -
class wp_jqplot_widget extends WP_Widget {

    /* constructor
    - - - - - - - - - */
    function wp_jqplot_widget() {
        parent::WP_Widget(false, $name = 'WordPress JQPlot');
    }
...
add_action('widgets_init', create_function('', 'return register_widget("wp_jqplot_widget");'));
